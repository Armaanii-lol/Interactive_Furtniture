...
var status_1, status_2, status_3, status_c;
...
registerOnClick('Sphere_black', false, false, [0,1,2], function() {
  assignMat('Table_Metal', 'Black_Paint');
}, function() {});

registerOnClick('Sphere_chrome', false, false, [0,1,2], function() {
  assignMat('Table_Metal', 'Chrome_Paint');
}, function() {});

registerOnClick('Sphere_white', false, false, [0,1,2], function() {
  assignMat('Table_Metal', 'White_Paint');
}, function() {});

registerOnClick('Slab1', false, false, [0,1,2], function() {
  replaceTexture('Main_table_0', 'Image', './Paint_edge_mat_baseColor.png', function() {});
}, function() {});

registerOnClick('Slab2', false, false, [0,1,2], function() {
  replaceTexture('Main_table_0', 'Image', './wood_basecolor_2.jpg', function() {});
}, function() {});

registerOnClick('Slab3', false, false, [0,1,2], function() {
  replaceTexture('Main_table_0', 'Image', './wood_basecolor_3.jpg', function() {});
}, function() {});
...
registerOnClick('Table_Drawers_1', false, false, [0,1,2], function() {
  if (status_1 == 'closed') {

    operateAnimation('PLAY', 'Table_Drawers_1', null, null, 'LoopOnce', 1,
            function() {
      status_1 = 'open';
    }, false);
    ...
    operateAnimation('PLAY', 'Table_Drawers_1', 1, 30, 'LoopOnce', 1,
            function() {
      status_1 = 'closed';
    }, true);
...
registerOnClick('Table_Drawers_2', false, false, [0,1,2], function() {
  if (status_2 == 'closed') {

    operateAnimation('PLAY', 'Table_Drawers_2', null, null, 'LoopOnce', 1,
            function() {
      status_2 = 'open';
    }, false);
    ...
    operateAnimation('PLAY', 'Table_Drawers_2', 1, 30, 'LoopOnce', 1,
            function() {
      status_2 = 'closed';
    }, true);
...
registerOnClick('Table_Drawers_3', false, false, [0,1,2], function() {
  if (status_3 == 'closed') {

    operateAnimation('PLAY', 'Table_Drawers_3', null, null, 'LoopOnce', 1,
            function() {
      status_3 = 'open';
    }, false);

        } else if (status_3 == 'open') {

    operateAnimation('PLAY', 'Table_Drawers_3', 1, 30, 'LoopOnce', 1,
            function() {
      status_3 = 'closed';
    }, true);
...
registerOnClick('Table_Cabinet', false, false, [0,1,2], function() {
  if (status_c == 'closed') {

    operateAnimation('PLAY', 'Table_Cabinet', null, null, 'LoopOnce', 1,
            function() {
      status_c = 'open';
    }, false);

        } else if (status_c == 'open') {

    operateAnimation('PLAY', 'Table_Cabinet', 1, 30, 'LoopOnce', 1,
            function() {
      status_c = 'closed';
    }, true);
